...
def get_link_classification_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='dbe_kt22_higher',
                        choices=['dbe_kt22_higher'])
    parser.add_argument('--batch_size', type=int, default=2000, help='batch size')
    parser.add_argument('--model_name', type=str, default='IKDG-KT', help='name of the model',
                        choices=['DyGKT','DACE','QIKT','IEKT','IPKT','DIMKT','simpleKT','CTNCM','AKT','DKT', 'TGAT', 'TGN', 'DyGFormer', 'IKDG-KT'])
    ...
    parser.add_argument('--lambda_struct', type=float, default=0.1, help='weight of the IKDG-KT structural alignment loss')
    parser.add_argument('--lambda_decay', type=float, default=0.1, help='temporal decay coefficient for IKDG-KT concept history')
    parser.add_argument('--use_time_decay_in_attention', action='store_true', help='enable exponential time decay in IKDG-KT history attention')
    parser.add_argument('--max_history_length', type=int, default=10, help='maximum stored interactions per knowledge concept for IKDG-KT')
